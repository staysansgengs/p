...
factory.on('PairCreated', async (token0, token1, pairAddress) => {
  ...
  const amountIn = ethers.utils.parseUnits('0.002', 'ether'); //jumalh beli pakai WBNB
try {
  ...
  if(pairBNBvalue > 5000000000000000000){ //minimal liquidity 25 BNB https://eth-converter.com
